...
function ca_script_init() {
    ...
    wp_enqueue_script( 'moment', get_template_directory_uri() . '/js/modules/moment.js', array('jquery'), '1.0.0', true );
    wp_enqueue_script( 'main_scripts', get_template_directory_uri() . '/js/site.min.js', array('jquery', 'moment'), '1.0.0', true );
}
